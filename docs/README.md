...
- **Stow Usage** – [STOW.md](../STOW.md)
- **Lazy Loading Overview** – [LAZY-LOADING.md](../LAZY-LOADING.md)

Add new documents under `docs/` when expanding workflows or platform notes. Keep references in this index and the root README updated.
