...
- `~/.config/zsh/zstyles.zsh`
  - fzf-tab 主题与行为（`--no-sort`）、completion 基础样式（`menu no`、`[ %d ]` 组名）；与 `~/.config/zsh/fzf.zsh` 共用 `--color=light,fg:#3a4d53,bg:#fbf3db,hl:#0072d4,fg+:#3a4d53,bg+:#e9e4d4,hl+:#0072d4,info:#009c8f,prompt:#c25d1e,spinner:#ca4898,pointer:#0072d4,marker:#ad8900,header:#489100,gutter:#fbf3db` 配色与按键绑定，调用 `ami-fzf-apply-theme dark|light` 会同步刷新 fzf-tab
- `~/.config/zsh/zshrc`
