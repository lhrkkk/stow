...
# Completion colors for light terminal (Solarized Light)
zstyle ':completion:*' menu select
if [[ -n "$LS_COLORS" ]]; then
  zstyle ':completion:*' list-colors ${(s.:.)LS_COLORS}
else
  # zstyle ':completion:*' list-colors 'no=00:fi=00:di=34:ln=36:pi=33:so=35:bd=1;34:cd=1;34:or=31:mi=31:ex=31:*.md=32:*.txt=32'
  zstyle ':completion:*' list-colors 'no=00:fi=00:di=34:ln=36:pi=33:so=35:bd=1;34:cd=1;34:or=31:mi=31:ex=32:*.md=34:*.txt=34:*.zip=31:*.tar=31:*.gz=31:*.tgz=31:*.7z=31:*.rar=31:*.bz2=31:*.xz=31'
fi

# fzf-completion: enforce colors to match terminal theme (Selenized Light - Gogh)
# export FZF_COMPLETION_OPTS='--color=light,fg:#3a4d53,bg:#fbf3db,hl:#0072d4,fg+:#3a4d53,bg+:#e9e4d4,hl+:#0072d4,info:#009c8f,prompt:#c25d1e,spinner:#ca4898,pointer:#0072d4,marker:#ad8900,header:#489100'
# fzf-tab: enforce colors to match terminal theme (Selenized Light - Gogh)
